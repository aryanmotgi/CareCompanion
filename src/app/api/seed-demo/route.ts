...
export async function POST() {
  ...
  await supabase.from('medications').insert([
    { care_profile_id: profile.id, name: 'Lisinopril', dose: '10mg', frequency: 'Once daily - Morning', prescribing_doctor: 'Dr. Patel', refill_date: dayISO(1), quantity_remaining: 3 },
    ...
    { care_profile_id: profile.id, name: 'Amlodipine', dose: '5mg', frequency: 'Once daily - Morning', prescribing_doctor: 'Dr. Patel', refill_date: dayISO(2), quantity_remaining: 5 },
