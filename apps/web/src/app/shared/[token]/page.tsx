...
const LabIcon = () => (
  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 0 1 4.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0 1 12 15a9.065 9.065 0 0 1-6.23-.693L4.2 15.3m15.6 0a2.25 2.25 0 0 1 .45 1.32v2.38A2.25 2.25 0 0 1 18 21H6a2.25 2.25 0 0 1-2.25-2.25v-2.38a2.25 2.25 0 0 1 .45-1.32" />
  </svg>
);
  ...
  return (
    <div className="min-h-screen" style={{ background: '#0c0c1a' }}>
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 space-y-5">
        ...
        {/* Lab Results */}
        {data.lab_results && data.lab_results.length > 0 && (
          <Section title={`Lab Results (${data.lab_results.length})`} icon={<LabIcon />}>
            <div className="space-y-2">
