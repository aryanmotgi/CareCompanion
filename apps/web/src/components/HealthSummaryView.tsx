    ...
    <div className="px-5 py-4 max-w-lg mx-auto">
      ...
      {!summary ? (
        ...
        <>
          {/* Export for Doctor */}
          <a
            href="/api/export/pdf?days=30"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-2 w-full py-2.5 mb-3 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-semibold transition-colors"
          >
