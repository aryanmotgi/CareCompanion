...
export function AppShell({
  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text)]">
      ...
      <main id="main-content" className={`${isSetup ? '' : (isDemo ? 'pt-[104px]' : (pathname === '/chat' ? 'pt-14' : 'pt-14'))} min-h-screen min-h-dvh`} style={isSetup ? undefined : { paddingBottom: pathname === '/chat' ? undefined : 'calc(var(--bottom-nav-height, 96px) + 16px)', '--top-bar-height': isDemo ? '104px' : '56px' } as React.CSSProperties}>
